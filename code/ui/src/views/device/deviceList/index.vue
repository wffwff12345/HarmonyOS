<template>
  <div class="app-container">
    <el-form :model="queryParams" ref="queryForm" size="small" :inline="true" v-show="showSearch" label-width="100px">
      ...
      <el-form-item label="设备状态码" prop="statusCode">
        <el-input
          v-model="queryParams.statusCode"
          placeholder="请输入设备状态码"
          clearable
          @keyup.enter.native="handleQuery"
        />
      </el-form-item>
      <!-- <el-form-item label="设备图片内容改变码" prop="changeCode">
        <el-input
          v-model="queryParams.changeCode"
          placeholder="请输入设备图片内容改变码"
          clearable
          @keyup.enter.native="handleQuery"
        />
      </el-form-item> -->
    ...
    <el-table v-loading="loading" :data="deviceList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="设备MAC地址" align="center" prop="deviceMac" />
      <el-table-column label="设备状态码" align="center" prop="statusCode" />
      <el-table-column label="设备图片内容改变码" align="center" prop="changeCode" />
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        ...
        <el-form-item label="设备状态码" prop="statusCode">
          <el-input v-model="form.statusCode" placeholder="请输入设备状态码" />
        </el-form-item>
        <!-- <el-form-item label="设备图片内容改变码" prop="changeCode">
          <el-input v-model="form.changeCode" placeholder="请输入设备图片内容改变码" />
        </el-form-item> -->
      </el-form>
